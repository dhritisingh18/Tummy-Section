...
export const cartReducer = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case UPDATE_CART_ITEM_SUCCESS:
            return {
                ...state, loading: false, cartItems: state.cartItems.map((item) =>
